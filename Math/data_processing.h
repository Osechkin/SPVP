...
#define INS_EMULDAT_PREPROC	90	// Эмуляция шума/сигнала и его предварительная обработка по Методу #1
#define INS_UPPDAT_PREPROC	91	// Предварительная обработка данных шума/сигнала по Методу #1
#define INS_DATA_PROC1		92	// Обработка данных шума и сигнала по Методу #1
...
typedef struct Processing_Params
{
	...
	int proc_cmd;				// номер пакета обработки данных для DUMMY_TOOL
